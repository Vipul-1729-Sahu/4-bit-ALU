...
2) IN CASE OF SUBTRACTION ONLY MAGNITUDE OF THE OUTPUT IS CONSIDERED NOT SIGN.
3) FOR SUBTRACTION , DURING 'A-B' ANY OF THE A AND B CAN BE GREATER **(NO RESTRICTION)** IN THIS MODEL.
